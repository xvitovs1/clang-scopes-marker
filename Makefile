...
LLVM_SRC_PATH := $$HOME/symbiotic/llvm-3.9.1
...
LLVM_BUILD_PATH := $$HOME/symbiotic/llvm-3.9.1/build
...
$(BUILDDIR)/scopes-marker: $(SRC_DIR)/scopes-marker.cpp
